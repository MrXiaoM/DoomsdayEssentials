...
import static top.mrxiaom.doomsdayessentials.external.haproxy.HAProxyConstants.*;

/**
 * A protocol proxied by HAProxy which is represented by its transport protocol and address family.
 * https://github.com/thijsa/SpigotProxy/blob/master/src/main/java/nl/thijsalders/spigotproxy/haproxy/HAProxyProxiedProtocol.java
 * @author thijsa
 */
