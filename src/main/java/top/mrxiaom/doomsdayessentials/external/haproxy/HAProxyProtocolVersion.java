...
import static top.mrxiaom.doomsdayessentials.external.haproxy.HAProxyConstants.VERSION_ONE_BYTE;
import static top.mrxiaom.doomsdayessentials.external.haproxy.HAProxyConstants.VERSION_TWO_BYTE;

/**
 * https://github.com/thijsa/SpigotProxy/blob/master/src/main/java/nl/thijsalders/spigotproxy/haproxy/HAProxyProtocolVersion.java
 * @author thijsa
 */
